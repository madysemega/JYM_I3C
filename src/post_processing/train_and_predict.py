...
Housing_Directory = '/home/ubuntu/JYM_I3C/data/processed/filtered_housing'
CUTOFF_DATE_1 = 56
CUTOFF_DATE_2 = 57
...
def prepare_data_for_prediction(df, cutoff, column_names):
    ...
    for target_column in column_names:
        ...
        n_lags = 5
        df_current = generate_time_lags(df_current, n_lags)
...
def main():
    ...
    with open('/home/ubuntu/JYM_I3C/data/processed/to_predict.json', 'r') as file:
    ...
    with Manager() as manager:
        ...
        for batch_start in tqdm(range(0, len(to_predict_items), batch_size), desc='Batch Progress'):
            ...
            for property_type_path, (columns, type) in current_batch:
                dataset_path = os.path.join(property_type_path, 'to_forecast.csv')
